		...
		<div class="box mtop">
			...
			<div class="rightbox">
				...
				<div class="cztable">
					...
					<form
						action="${pageContext.request.contextPath }/student/changepwd"
						name="changepwd" method="post" onsubmit="return changePassword()">
						<table border="0" cellspacing="0" cellpadding="0" width="500px"
							...
							<tr align="center">
								...
								<td style="width: 70%; text-align: left;"><input
									...
									class="input_2 txtinput1" name="oldpwd" /></td>
							</tr>
							<tr align="center">
								<th style="width: 20%; text-align: left;">新密码：</th>
								<td style="width: 70%; text-align: left;"><input
									id="txtNewPwd" value="" type="password"
									class="input_2 txtinput1" name="newpwd" />&nbsp;&nbsp;6~16个字符，区分大小写</td>
							</tr>
							<tr align="center">
								<th style="width: 20%; text-align: left;">确认新密码：</th>
								<td style="width: 70%; text-align: left;"><input
									id="txtConfirmNewPwd" value="" type="password"
									class="input_2 txtinput1" name="newpwd2" /></td>
							</tr>
							<tr>
								<td colspan="2" style="text-align: center;"><input
									type="submit" id="btnSubmit" value="确认修改" class="input2" /></td>
