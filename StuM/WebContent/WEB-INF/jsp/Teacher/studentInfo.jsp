...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("a.edit").fancybox({
			...
			'showCloseButton' : false,
			'onClosed' : function() {
				window.location.href = '${pageContext.request.contextPath}/admin/selectStudentInClass?id=${teacher.classes}';
			}
		});
	});
	/* // 用户角色  
				...
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%"
						...
						<tr>
							...
							<!-- <td>公租房</td>
							<td>建成待租</td> -->
							<td><a href="${pageContext.request.contextPath}/admin/editStudent?id=${student.stuid}"
