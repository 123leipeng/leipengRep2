								...
								.fancybox(
										{
											...
											'showCloseButton' : false,
											'onClosed' : function() {
												window.location.href = '${pageContext.request.contextPath}/admin/selectStuInClass?id=${list[0].courseid}';
											}
										});
					});
	/* // 用户角色  
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%"
						...
						<c:forEach items="${list }" var="score" varStatus="status">
							...
							<tr>
								...
								<td>${score.student.stuid }</td>
								<td>${score.student.sname }</td>
								<td>${score.student.classesname }</td>
								<td>${score.paperscore }</td>
								<td>${score.usualscore }</td>
								<td>${score.allscore }</td>
								<!-- <td>公租房</td>
							<td>建成待租</td> -->
								<td><a
									href="${pageContext.request.contextPath}/admin/editScore?id=${score.scoreid}"
									class="edit">编辑</a> <!-- <a href="javascript:del('14458579642011');">删除</a> --></td>
							</tr>
						</c:forEach>
