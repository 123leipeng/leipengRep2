...
<script
	src="${pageContext.request.contextPath }/Scripts/My97DatePicker/WdatePicker.js"
...
<body>
	<form action="${pageContext.request.contextPath }/admin/updateStudent"
		...
		<div id="container">
			<div id="nav_links">
				当前位置：学生信息&nbsp;>&nbsp;<span style="color: #1A5CC6;">编辑</span>
				<div id="page_close">
			...
			<div class="ui_content">
				...
				<tr>
					...
					<tr>
						...
						<td class="ui_text_lt"><input type="hidden" name="stuid"
							value="${student.stuid }" /> <input type="text"
							disabled="disabled" value="${student.stuid }"
							class="ui_input_txt02" /></td>
					</tr>
					<tr>
						<td class="ui_text_rt">姓名</td>
						<td class="ui_text_lt"><input type="hidden" name="sname"
							value="${student.sname }" /> <input type="text"
							disabled="disabled" id="sname" name="sname"
							value="${student.sname }" class="ui_input_txt02" /></td>
					</tr>
					<tr>
						<td class="ui_text_rt">身份证号</td>
						<td class="ui_text_lt"><input type="hidden" name="idnum"
							value="${student.idnum }" /> <input type="text"
							disabled="disabled" name="idnum" value="${student.idnum }"
							class="ui_input_txt02" /></td>
					</tr>
					<tr>
						<td class="ui_text_rt">生源地</td>
						<td class="ui_text_lt"><input type="hidden" name="syd"
							value="${student.syd }" /> <input type="text"
							disabled="disabled" name="syd" value="${student.syd }"
							class="ui_input_txt02" /></td>
					</tr>
					<tr>
						<td class="ui_text_rt">学生状态</td>
						<td class="ui_text_lt"><select name="statu"
							class="ui_select01">
								<option value="${student.statu }" selected="selected">${student.statu }</option>
								<c:if test="${student.statu=='在读'}">
									<option value="休学">休学</option>
								</c:if>
								<c:if test="${student.statu=='休学' }">
					...
					<tr>
						...
						<td class="ui_text_lt"><input type="text" name="phone"
							value="${student.phone }" class="ui_input_txt02" /></td>
					</tr>
					<tr>
				...
				<tr>
					...
					<tr>
						<td>&nbsp;</td>
						<td class="ui_text_lt">&nbsp;<a><input id="submitbutton"
								type="submit" value="提交" class="ui_input_btn01" /></a> &nbsp;<a
