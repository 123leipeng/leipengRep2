...
<title></title>
<link
	href="${pageContext.request.contextPath }/Style/authority/main_css.css"
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath }/Style/authority/zTreeStyle.css"
	rel="stylesheet" type="text/css">
<script type="text/javascript"
	src="${pageContext.request.contextPath }/Script/jquery/jquery-1.7.1.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath }/Script/zTree/jquery.ztree.core-3.2.js"></script>
<script type="text/javascript"
...
<script type="text/javascript">
	...
	function logout() {
		if (confirm("您确定要退出本系统吗？")) {
			window.location.href = "${pageContext.request.contextPath}/teacher/quit";
		}
	}
...
<script type="text/javascript">
	...
	function loadMenu(resourceType, treeObj) {
		...
		data = [{
			...
			"accessPath" : "${pageContext.request.contextPath}/admin/selectClass?id=${teacher.classes}",
			"checked" : false,
			"delFlag" : 0,
			"parentID" : 10,
			"resourceCode" : "",
			...
			"accessPath" : "${pageContext.request.contextPath}/admin/selectStudentInClass?id=${teacher.classes}",
			"checked" : false,
			"delFlag" : 0,
			"parentID" : 10,
			"resourceCode" : "",
			...
			"accessPath" : "${pageContext.request.contextPath }/admin/courseList?id=${teacher.tid}",
			"checked" : false,
			"delFlag" : 0,
			"parentID" : 2,
			"resourceCode" : "",
			...
			"accessPath" : "${pageContext.request.contextPath }/admin/courseAddPage",
			"checked" : false,
			"delFlag" : 0,
			"parentID" : 2,
			"resourceCode" : "",
...
<body onload="getDate01()">
			...
			<div id="top_op">
				<ul>
					<li><img alt="当前用户"
						...
						<span>${teacher.tname }</span></li>
					<li><img alt="事务月份"
						src="${pageContext.request.contextPath }/images/common/month.jpg">：
						<span id="yue_fen"></span></li>
					<li><img alt="今天是"
	...
	<!-- side menu start -->
	<div id="top_nav">
		<span id="here_area">当前位置：首页&nbsp;>&nbsp;</span>
	</div>
	<div id="main">
		<iframe name="right" id="rightMain" src=""
	...
	<script type="text/javascript">
		$(function() {
			$('#rightMain').attr('src',
					'${pageContext.request.contextPath}/admin/introduce');
