	...
	<body>
		<div id="tab">
			...
			<div class="tab_box">
				<!-- 导师登录开始-->
				<div>
					<div class="tea_error_box" style="color:red">
					<c:if test="${msg==1 }">账号或密码错误</c:if>
					</div>
					<form action="${pageContext.request.contextPath }/teacher/login" method="post" class="tea_login_error">
						<div id="username">
							<label>教工号：</label>
							<input type="text" id="tea_username_hide" name="username"  placeholder="输入教工号" nullmsg="教工号不能为空！" datatype="s6-18" errormsg="教工号范围在6~18个字符之间！" sucmsg="教工号验证通过！" />
					...
					<div align="center"><font color="red" size="3">账号：10001 ~~ 10006</font></div>
			        <div align="center"><font color="red"  size="3">密码：123456</font></div>
				</div>
				<!-- 导师登录结束-->
		...
		<div class="screenbg">
			<ul>
				<li>
					<a href="javascript:;"><img src="${pageContext.request.contextPath }/images/0.jpg"></a>
				</li>
				<li>
					<a href="javascript:;"><img src="${pageContext.request.contextPath }/images/1.jpg"></a>
				</li>
				<li>
					<a href="javascript:;"><img src="${pageContext.request.contextPath }/images/2.jpg"></a>
				</li>
			</ul>
		</div>
	</body>
