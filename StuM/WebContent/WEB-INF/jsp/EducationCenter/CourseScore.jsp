...
<%-- <script src="${pageContext.request.contextPath}/Script/Base.js"
	type="text/javascript"></script>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tbody>
							<tr style="height: 25px" align="center">
								...
								<th scope="col">课程卷面分</th>
								<th scope="col">课程平时分</th>
								<th scope="col">课程总分</th>
							</tr>
							<c:forEach items="${list }" var="score" varStatus="statu">
								<tr align="center">
									<td>${statu.index+1 }</td>
									<td>${score.course.coursename }</td>
									<td>${score.course.courseteacher }</td>
									<td>${score.course.coursescore }</td>
